              ...
              <div className="w-full max-w-xl space-y-8">
                ...
                <div className="space-y-6">
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-3 px-4 py-3.5 bg-white border border-slate-200 rounded-2xl text-slate-700 hover:bg-slate-50 hover:border-slate-300 transition-all font-semibold shadow-sm"
                  >
