...
export default function LandingPage() {
  ...
  const [guestBranding, setGuestBranding] = useState({
    businessName: '',
    email: '',
    phone: '',
    address: '',
        ...
        >
          ...
          >
            ...
            <p style={{ color: '#64748b', marginBottom: 24, lineHeight: 1.5 }}>
              Enter your business details to start making invoices immediately. This data is
              temporary and will be cleared when you close the tab.
            </p>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
              <input
                ...
                onChange={(e) =>
                  setGuestBranding({ ...guestBranding, businessName: e.target.value })
                }
                style={{
                  padding: '12px 16px',
                  borderRadius: 12,
              ...
              <input
                ...
                onChange={(e) =>
                  setGuestBranding({ ...guestBranding, gstin: e.target.value } as any)
                }
                style={{
                  padding: '12px 16px',
                  borderRadius: 12,
              ...
              <button
                onClick={() => {
                  ...
                  let settings = {
                    ...
                    businessName: guestBranding.businessName || 'Guest Business',
                  };
                  ...
                  sessionStorage.setItem(
                    'guest_mode_bill_branding_settings',
