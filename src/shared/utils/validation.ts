...
export const ValidationRules = {
  ...
  gst: {
    ...
    format: (val: string) => val.replace(/[^a-zA-Z0-9]/g, '').toUpperCase().slice(0, 15),
    maxLength: 15
  },
 ...
 */
export const validateInput = (type: keyof typeof ValidationRules, value: string | undefined | null): string | null => {
