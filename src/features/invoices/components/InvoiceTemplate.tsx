        ...
        <div style={{ display: 'flex', height: '100%', flex: 1 }}>
            ...
            <div style={{ width: '35%', backgroundColor: brandColor, color: '#ffffff', padding: '40px 30px', display: 'flex', flexDirection: 'column' }}>
                ...
                <div style={{ marginTop: 'auto' }}>
                    {settings.website && (
                      <p style={{ fontSize: '11px', color: 'rgba(255,255,255,0.8)', fontWeight: 600 }}>{settings.website}</p>
                    )}
                </div>
            </div>
    ...
    >
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', backgroundColor: '#ffffff', padding: '32px 28px', borderBottom: `4px solid ${brandColor}` }}>
        ...
        <div style={{ flex: 1, display: 'flex', alignItems: 'center', gap: '16px' }}>
          ...
          <div>
            <div style={{ color: '#1e293b', fontWeight: 900, fontSize: '28px', letterSpacing: '-1px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
          {storeInfo?.phone && (
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              <span style={{ fontSize: '16px', fontWeight: 700, color: '#1a1a2e' }}>{storeInfo.phone}</span>
            </div>
          )}
          {storeInfo?.email && (
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <span style={{ fontSize: '20px', width: '24px', textAlign: 'center' }}>✉</span>
              <span style={{ fontSize: '16px', fontWeight: 700, color: '#1a1a2e' }}>{storeInfo.email}</span>
            </div>
          )}
          {storeInfo?.address && (
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <span style={{ fontSize: '20px', width: '24px', textAlign: 'center' }}>📍</span>
              <span style={{ fontSize: '16px', fontWeight: 700, color: '#1a1a2e' }}>{storeInfo.address}</span>
            </div>
          )}
        </div>
        <div style={{ marginTop: '20px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', opacity: 0.5, fontSize: '12px' }}>
