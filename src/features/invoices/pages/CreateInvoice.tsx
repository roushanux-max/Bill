...
import { Invoice, InvoiceItem, Customer, Product, StoreInfo } from '@/features/invoices/types/invoice';
import { getCustomers, saveCustomer, getProducts, saveProduct, saveInvoice, getInvoices, getInvoice, getStoreInfo, getBrandingSettings, getNextInvoiceNumber, searchCustomers, searchProducts, getUserKey, safeGet, safeSet, safeRemove } from '@/shared/utils/storage';
