...
const SUPABASE_URL = 'https://whmmhfldrigyyqqlqygo.supabase.co';
...
// Create a master admin client using service role key if we had it, but we only have anon key.
// We will create 5 different clients for 5 different users to isolate their sessions.
